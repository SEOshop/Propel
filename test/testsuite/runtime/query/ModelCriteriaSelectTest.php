...
class ModelCriteriaSelectTest extends BookstoreTestBase
{
    ...
    */
    ...
    public function testSelectStringAuthorFindOne()
    {
        ...
        $this->assertEquals($author, 'Neal', 'findOne() called after select(string) allows for where() statements');
    ...
    public function testSelectStringJoin()
    {
        ...
        $c->select('Title');
        $title = $c->findOne($this->con);
        $this->assertEquals($title, 'Quicksilver', 'findOne() called after select(string) allows for join() statements');
